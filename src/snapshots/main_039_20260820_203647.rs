...
fn main() {
    ...
    raphael.insert(String::from("Raphael"), 100);
    raphael.insert(String::from("Samuel"), 200);
    raphael.insert(String::from("Daniel"), 300);
    raphael.insert(String::from("Albert"), 400);
    raphael.insert(String::from("Robert"), 500);
    println!("{:?}", raphael);
    println!("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");

    raphael.insert(String::from("Raphael"), 101);
    raphael.insert(String::from("Samuel"), 201);
    raphael.insert(String::from("Daniel"), 301);
    raphael.insert(String::from("Albert"), 401);
    raphael.insert(String::from("Robert"), 501);
    println!("{:?}", raphael);
    println!("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
