...
// Goal: remove number from a phrase
...
fn main() {
    ...
    let message =
        String::from("libcurl: 8.21.0-DEV (sys:0.4.90+curl-8.21.0 vendored ssl:OpenSSL/3.6.3)");

    let char_arr = message.chars();
