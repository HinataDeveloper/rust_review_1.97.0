...
fn main() {
    ...
    println!("value of samuel is : {:?}", samuel);

    // encounter with compile time error. beacause username and email
    // were moved from raphael into samuel object.
    println!("value of raphael is: {:?}", raphael);
